...
== The Structure
git 
The koans are broken out into areas by file, hashxxxdddes are covered in +about_hashes.rb+,
modules are introduced isssssssssn +about_modules.rb+, <em>etc</em>.  They are presented in
